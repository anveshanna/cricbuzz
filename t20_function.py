...
DF_PARAMS = {
    ...
    "outputTable": "gcp-batch-5-project-1.stats_icc_rankings_dataset.t20_batting_ranking",
    "inputFilePattern": "gs://bkt-rank-data-t20/t20_batsmen_rankings.csv",
...
def trigger_df_job(cloud_event, environment=None):
    svc = _df_client()
    job_name = f"t20_stats_icc_rankings-{datetime.datetime.utcnow():%Y%m%d-%H%M%S}"
